                ...
                <div className="col-span-12 lg:col-span-9 space-y-6">
                    ...
                    <div className="flex items-center justify-between">
                        ...
                        <div className="flex gap-1">
                            {/* Expand All Public Betting Toggle (only shows in Simulated view) */}
                            {activeTab === 'simulated' && (
                                <button
                                    onClick={() => setExpandAllPublicBetting(!expandAllPublicBetting)}
                                    title={expandAllPublicBetting ? "Collapse All Public Betting" : "Expand All Public Betting"}
                                    className={`flex items-center gap-2 px-3 rounded border transition-all mr-2 ${expandAllPublicBetting
                                        ? 'bg-primary/10 border-primary/40 text-primary'
                                        : 'border-border-muted text-text-muted hover:text-text-main hover:bg-neutral-800'
                                        }`}
                                >
                                    <span className="material-symbols-outlined text-sm">
                                        {expandAllPublicBetting ? 'unfold_less' : 'unfold_more'}
                                    </span>
                                        ...
                                        <div className={layoutMode === 'grid'
                                            ...
                                            {groupGames.map(game => (
                                                <GameCard
                                                    ...
                                                    onAddBet={onAddBet}
                                                    expandAllPublicBetting={expandAllPublicBetting}
                                                />
                                            ))}
                                        </div>
                                    </div>
