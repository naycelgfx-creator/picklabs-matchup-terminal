...
interface GameCardProps {
    ...
    expandAllPublicBetting?: boolean;
}

export const GameCard: React.FC<GameCardProps> = ({ game, onSelectGame, onAddBet, expandAllPublicBetting }) => {
    ...
    return (
        <div className="terminal-panel p-5 space-y-6 flex flex-col justify-between">
            ...
            <div className="mt-4 -mx-5 -mb-5 rounded-b-xl overflow-hidden flex flex-col">
                ...
                <PublicBetting game={game} onMatchDetailsClick={onSelectGame} expandAll={expandAllPublicBetting} />
            </div>
        </div>
    );
};
