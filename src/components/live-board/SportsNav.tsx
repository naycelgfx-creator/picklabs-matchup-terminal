...
const SPORT_LOGOS: Record<string, { primary: string; fallback: string }> = {
    ...
    NCAAB: {
        primary: 'https://a.espncdn.com/i/teamlogos/leagues/500/ncaab.png',
        fallback: 'https://sports.cbsimg.net/fly/images/icon-logos/basketball.svg',
    },
    NCAAW: {
        primary: 'https://a.espncdn.com/i/teamlogos/leagues/500/ncaaw.png',
        fallback: 'https://sports.cbsimg.net/fly/images/icon-logos/basketball.svg',
    },
    ...
    Tennis: {
        primary: 'https://a.espncdn.com/i/tennislos/atp/500/wimbledon.png',
        fallback: 'https://a.espncdn.com/i/tennislos/atp/500/wimbledon.png',
    },
    Golf: {
...
export const SportsNav: React.FC<SportsNavProps> = ({ activeSport, onSelectSport }) => {
    return (
        <div className="bg-white dark:bg-neutral-900/40 border-b border-border-muted z-40 overflow-hidden">
            <div className="max-w-[1536px] mx-auto px-6 py-4">
                <div className="flex items-center justify-center gap-4 xl:gap-8 overflow-x-auto custom-scrollbar pb-2">
                    {SPORTS.map(sport => {
