...
export const LandingPageView: React.FC<LandingPageViewProps> = ({ onNavigate }) => {
    ...
    return (
        <div className="overflow-x-hidden font-display bg-background-dark text-slate-100 min-h-screen selection:bg-primary selection:text-black">
            ...
            <section className="max-w-7xl mx-auto px-6 py-32 border-b border-border-muted relative">
                ...
                <div className="mt-16 relative z-10 border-t border-border-muted pt-16">
                    <div className="text-center mb-12">
                        <h2 className="text-2xl md:text-3xl font-black italic uppercase text-text-main tracking-tight">
            ...
            {/* --- DATA FEED SECTION --- */}
            <section id="data-feed" className="max-w-7xl mx-auto px-6 py-32 border-b border-border-muted relative">
                <div className="flex flex-col lg:flex-row gap-16 items-center">
                    <div className="flex-1 space-y-6 relative z-10">
                        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-primary/10 border border-primary/30 text-primary text-[10px] font-black uppercase tracking-widest mb-2">
                            <span className="material-symbols-outlined text-sm">bolt</span>
                            Consumer Data Feed
                        </div>
                        <h2 className="text-3xl md:text-5xl font-black italic uppercase text-text-main tracking-tight leading-tight">
                            The Fastest <span className="text-primary">Data Engine</span> in Sports.
                        </h2>
                        <p className="text-text-muted text-sm md:text-base leading-relaxed max-w-xl font-medium">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-6">
                            {[
                                { title: 'Live Match Coverage', icon: 'scoreboard', desc: 'Sub-second updates on 8+ global leagues.' },
                                { title: 'Injury Intelligence', icon: 'healing', desc: 'Instant depth chart and roster adjustments.' },
                                { title: 'Advanced Player Logs', icon: 'monitoring', desc: 'Deep L5/L10/L20 vs Opponent historicals.' },
                                { title: 'Breaking News Filters', icon: 'feed', desc: 'Curated sharp news directly affecting lines.' }
                            ].map((feature, i) => (
                                <div key={i} className="flex items-start gap-4">
                                    <div className="w-10 h-10 rounded-lg bg-neutral-900 border border-border-muted flex items-center justify-center shrink-0">
                                        <span className="material-symbols-outlined text-primary text-xl">{feature.icon}</span>
                                    </div>
                                    <div>
                                        <h5 className="text-xs font-black uppercase text-text-main mb-1">{feature.title}</h5>
                                        <p className="text-[10px] text-text-muted font-medium">{feature.desc}</p>
                                    </div>
                                </div>
                            ))}
                        </div>
                    ...
                    <div className="flex-1 w-full relative z-10">
                        ...
                        <div className="terminal-panel p-2 shadow-2xl border-primary/20 relative bg-background-dark/80 backdrop-blur-sm">
                            <div className="flex items-center gap-2 border-b border-border-muted px-4 py-3 bg-neutral-900/50">
                                <span className="w-2.5 h-2.5 rounded-full bg-red-500"></span>
                                <span className="w-2.5 h-2.5 rounded-full bg-yellow-500"></span>
                                <span className="w-2.5 h-2.5 rounded-full bg-green-500"></span>
                                <span className="text-[10px] font-bold text-slate-500 uppercase tracking-widest ml-4">Live Play-by-Play Feed</span>
                            </div>
                            <div className="p-4 space-y-3 font-mono text-xs">
                                <div className="flex gap-4 items-center">
                                    <span className="text-slate-600">Q4 02:14</span>
                                    <span className="text-primary font-bold">EVENT</span>
                                    <span className="text-slate-300">L. James makes 28-foot three point jumper (A. Davis assists)</span>
                                </div>
                                <div className="flex gap-4 items-center opacity-80">
                                    <span className="text-slate-600">Q4 02:40</span>
                                    <span className="text-accent-purple font-bold">ALERT</span>
                                    <span className="text-slate-300">LAL Moneyline shifts from -110 to -145 across 4 books.</span>
                                </div>
                                <div className="flex gap-4 items-center opacity-60">
                                    <span className="text-slate-600">Q4 03:01</span>
                                    <span className="text-accent-blue font-bold">INJURY</span>
                                    <span className="text-slate-300">S. Curry (GSW) heading to locker room (Ankle).</span>
                                </div>
                                <div className="flex gap-4 items-center opacity-40">
                                    <span className="text-slate-600">Q4 03:15</span>
                                    <span className="text-primary font-bold">EVENT</span>
                                    <span className="text-slate-300">Golden State full timeout.</span>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            {/* --- API SECTION --- */}
            <section id="api" className="max-w-7xl mx-auto px-6 py-32 border-b border-border-muted relative bg-[#0a0a0a]">
                <div className="absolute top-0 left-0 w-full h-full bg-accent-blue/5 pointer-events-none blur-[120px] rounded-full scale-150 transform translate-y-1/2 opacity-20"></div>
                <div className="flex flex-col lg:flex-row-reverse gap-16 items-center">
                    <div className="flex-1 space-y-6 relative z-10 lg:pl-10">
                        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-accent-blue/10 border border-accent-blue/30 text-accent-blue text-[10px] font-black uppercase tracking-widest mb-2">
                            <span className="material-symbols-outlined text-sm">code</span>
                            Developer API
                        </div>
                        <h2 className="text-3xl md:text-5xl font-black italic uppercase text-text-main tracking-tight leading-tight">
                            Build with the <span className="text-accent-blue">Ultimate API.</span>
                        </h2>
                        <p className="text-text-muted text-sm md:text-base leading-relaxed max-w-xl font-medium">
                            Power your own applications, sportsbooks, or analytical tools with our enterprise-grade REST and WebSocket APIs. Access raw data for <strong>every major sport</strong> from a single endpoint.
                        </p>
                        ...
                        <ul className="space-y-4 pt-6">
                            {[
                                ...
                                <li key={i} className="flex items-center gap-3 text-xs md:text-sm font-bold text-slate-300 uppercase tracking-wide">
                                    <span className="w-1.5 h-1.5 bg-accent-blue rounded-full shadow-[0_0_8px_rgba(59,130,246,0.8)]"></span>
                                    {item}
                                </li>
                            ))}
                        </ul>
                        ...
                        <div className="pt-8">
                            <button onClick={() => onNavigate('login-page')} className="px-8 py-4 bg-transparent border-2 border-accent-blue text-accent-blue font-black uppercase tracking-[0.2em] italic rounded-xl hover:bg-accent-blue hover:text-black transition-all shadow-[0_0_15px_rgba(59,130,246,0.2)]">
                                View Documentation
                            </button>
                        </div>
                    </div>
                    ...
                    <div className="flex-1 w-full relative z-10">
                        <div className="terminal-panel p-0 overflow-hidden shadow-2xl border-accent-blue/20">
                            <div className="flex justify-between items-center border-b border-neutral-800 bg-neutral-950 px-4 py-2">
                                <div className="flex items-center gap-4">
                                    <span className="text-[10px] text-accent-blue font-bold uppercase tracking-widest">GET /v1/sports/nba/live</span>
                                </div>
                                <span className="text-[10px] text-slate-500 font-mono">200 OK</span>
                            </div>
                            <div className="p-6 bg-[#0d0d12] overflow-x-auto">
                                <pre className="text-[11px] font-mono text-slate-300 leading-relaxed">
                                    <span className="text-pink-400">{"{"}</span>
                                    <span className="text-blue-300">"status"</span>: <span className="text-yellow-200">"success"</span>,
                                    <span className="text-blue-300">"data"</span>: <span className="text-pink-400">{"{"}</span>
                                    <span className="text-blue-300">"gameId"</span>: <span className="text-orange-300">"401584692"</span>,
                                    <span className="text-blue-300">"teams"</span>: <span className="text-pink-400">{"{"}</span>
                                    <span className="text-blue-300">"away"</span>: <span className="text-yellow-200">"LAL"</span>,
                                    <span className="text-blue-300">"home"</span>: <span className="text-yellow-200">"GSW"</span>
                                    <span className="text-pink-400">{"}"}</span>,
                                    <span className="text-blue-300">"score"</span>: <span className="text-pink-400">{"{"}</span>
                                    <span className="text-blue-300">"away"</span>: <span className="text-orange-300">112</span>,
                                    <span className="text-blue-300">"home"</span>: <span className="text-orange-300">109</span>
                                    <span className="text-pink-400">{"}"}</span>,
                                    <span className="text-blue-300">"clock"</span>: <span className="text-yellow-200">"02:14"</span>,
                                    <span className="text-blue-300">"period"</span>: <span className="text-orange-300">4</span>,
                                    <span className="text-blue-300">"injuries"</span>: <span className="text-yellow-400">[</span>
                                    <span className="text-pink-400">{"{"}</span> <span className="text-blue-300">"player"</span>: <span className="text-yellow-200">"S. Curry"</span>, <span className="text-blue-300">"status"</span>: <span className="text-yellow-200">"OUT"</span> <span className="text-pink-400">{"}"}</span>
            ...
            <section id="pricing" className="max-w-7xl mx-auto px-6 py-32">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-stretch max-w-6xl mx-auto">
                    <div className="pricing-card">
                        <div className="mb-6">
                            ...
                            <p className="text-[10px] font-bold text-slate-500 uppercase tracking-widest invisible">Placeholder spacing</p>
                        </div>
                    ...
                    <div className="pricing-card featured relative md:-mt-4 md:mb-4 border-accent-purple/50 bg-neutral-900 shadow-[0_0_30px_rgba(168,85,247,0.15)]">
                ...
                <div className="mt-20 flex justify-center">
                    <button onClick={() => onNavigate('login-page')}
                        className="px-12 py-5 bg-slate-900 dark:bg-neutral-900 border border-neutral-700 text-white font-black uppercase tracking-[0.2em] italic rounded-xl hover:bg-black dark:hover:bg-neutral-800 transition-all drop-shadow-xl flex items-center justify-center gap-3 group">
                        <span className="material-symbols-outlined text-lg group-hover:text-primary transition-colors">login</span>
                        MEMBER LOGIN
                    </button>
                </div>
            </section>
