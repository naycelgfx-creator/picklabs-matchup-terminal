                ...
                {tiers.map((tier) => {
                    ...
                    return (
                        <div
                            key={tier.name}
                            className={cn(
                                'pricing-card flex flex-col relative transition-all duration-300',
                                tier.highlight && tier.accentColor === 'purple' && 'border-accent-purple/50 bg-neutral-900 shadow-[0_0_30px_rgba(168,85,247,0.15)] xl:-mt-4 xl:mb-4',
                        ...
                        >
                            ...
                            >
                                <span className="flex items-center justify-center gap-2">
                                    {tier.ctaLabel ?? (tier.highlight ? 'Get Started' : 'Get Started')}
